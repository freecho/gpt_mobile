...
interface ChatRepository {
    ...
    suspend fun completeChatWithTools(userMessages: List<MessageV2>, assistantMessages: List<List<MessageV2>>, platform: PlatformV2, enabledTools: Set<String>): Flow<ApiState>
    ...
    suspend fun updateChatEnabledTools(chatRoom: ChatRoomV2, enabledTools: Set<String>)
